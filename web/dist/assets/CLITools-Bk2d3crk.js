...
# Chạy
npm start`}),(0,g.jsxs)(`div`,{className:`grid grid-cols-2 gap-3 mt-2`,children:[(0,g.jsxs)(`div`,{className:`bg-muted/50 rounded-lg px-3 py-2`,children:[(0,g.jsx)(`p`,{className:`text-[10px] text-muted-foreground mb-1`,children:`Endpoint`}),(0,g.jsx)(`code`,{className:`text-xs text-orange-400`,children:`POST /v1/chat/completions`})]}),(0,g.jsxs)(`div`,{className:`bg-muted/50 rounded-lg px-3 py-2`,children:[(0,g.jsx)(`p`,{className:`text-[10px] text-muted-foreground mb-1`,children:`Events`}),(0,g.jsx)(`code`,{className:`text-xs text-blue-400`,children:`GET /events (SSE)`})]})]})]}),(0,g.jsx)(p,{className:`bg-muted/30 border-border`,children:(0,g.jsx)(d,{className:`pt-4`,children:(0,g.jsx)(`ul`,{className:`space-y-2`,children:[`Agyproxy tự động xoay vòng accounts khi một account bị cooldown`,`Cooldown tự động reset sau khi hết thời gian (mặc định 60s)`,`Dùng /events SSE để theo dõi log realtime`,`Quota summary có sẵn tại /api/gateway/quota-summary`,`Models list tại /api/gateway/models — trả về tất cả model hỗ trợ`].map((e,t)=>(0,g.jsxs)(`li`,{className:`flex items-start gap-2 text-xs text-muted-foreground`,children:[(0,g.jsx)(i,{className:`h-3 w-3 text-orange-500 flex-shrink-0 mt-0.5`}),e]},t))})})})]})}export{y as CLITools};