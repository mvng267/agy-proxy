...
print(message.content[0].text)`})]})]})]}),(0,g.jsx)(s,{className:`bg-slate-800`}),(0,g.jsxs)(v,{icon:l,title:`Quản lý Combo`,badge:`Advanced`,children:[(0,g.jsx)(`p`,{className:`text-xs text-slate-400`,children:`Combo cho phép nhóm nhiều models với chiến lược round-robin hoặc fallback:`}),(0,g.jsxs)(`div`,{className:`space-y-3`,children:[(0,g.jsxs)(`div`,{children:[(0,g.jsx)(`p`,{className:`text-xs text-slate-500 mb-2`,children:`Tạo combo mới`}),(0,g.jsx)(_,{lang:`bash`,code:`curl -X POST http://localhost:7788/api/combos \\
  -H "Content-Type: application/json" \\
  -d '{
    "id": "my-combo",
...
curl http://localhost:7788/v1/chat/completions \\
  ...
  }'`})]})]})]}),(0,g.jsxs)(v,{icon:o,title:`Setup Hermes / OmniRoute`,children:[(0,g.jsx)(`p`,{className:`text-xs text-slate-400`,children:`Kết nối Hermes để dùng nhiều provider:`}),(0,g.jsx)(_,{lang:`bash`,code:`# Clone và cài
